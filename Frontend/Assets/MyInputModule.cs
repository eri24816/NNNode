    ...
    public class MyInputModule : PointerInputModule
    {
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            if (!Mathf.Approximately(leftButtonData.buttonData.scrollDelta.sqrMagnitude, 0.0f))
            {
                ...
                if (ExecuteEvents.ExecuteHierarchy(leftButtonData.buttonData.pointerCurrentRaycast.gameObject, leftButtonData.buttonData, ExecuteEvents.scrollHandler) == null)
                    scrollFallback(leftButtonData.buttonData);
            }
        }
        ...
        protected override void ProcessMove(PointerEventData pointerEvent)
        {
            ...
            HandlePointerExitAndEnterBetter(pointerEvent, targetGO);
        }
        ...
        void HandlePointerExitAndEnterBetter(PointerEventData currentPointerData, GameObject newEnterTarget)
        {
            ...
            if (currentPointerData.pointerEnter != null)
            {
                ...
                while (t != null)
                {
                    ...
                    bool hasSentExit = ExecuteEvents.Execute(t.gameObject, currentPointerData, ExecuteEvents.pointerExitHandler);
                    currentPointerData.hovered.Remove(t.gameObject);

                    // if we reach the common root break out!
                    if (commonRoot != null && commonRoot.transform == t || hasSentExit)
                        break;
                    t = t.parent;
                }
            }
            ...
            if (newEnterTarget != null)
            {
                ...
                while (t != null)
                {
                    ...
                    bool hasSentEnter = ExecuteEvents.Execute(t.gameObject, currentPointerData, ExecuteEvents.pointerEnterHandler);
                    ExecuteEvents.Execute(t.gameObject, currentPointerData, ExecuteEvents.pointerMoveHandler);
                    currentPointerData.hovered.Add(t.gameObject);
                    if (commonRoot != null && commonRoot.transform == t || hasSentEnter)
                        break;
                    t = t.parent;
                }
            }
