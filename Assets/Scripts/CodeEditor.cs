...
namespace TMPro
{
    ...
    /// </summary>
    public class CodeEditor : Selectable,
        ...
        IScrollHandler
    {
        ...
        [SerializeField]
        private RectTransform m_lineNumberTransform;

        [SerializeField]
        private TMP_Text m_lineNumber;
        int m_lineCount=-1;
        ...
        private float m_DoubleClickDelay = 0.2f;
        ...
        private void Insert(char c)
        {
            ...
            if (c == '\t')
            {
                replaceString = "    "; // python indent
                while (insertPos>0 && m_Text[insertPos-1] != '\n')
                    insertPos--;
            ...
            if (!char.IsHighSurrogate(c))
                m_CaretSelectPosition = m_CaretPosition += replaceString.Length;

            m_StringSelectPosition = m_StringPosition += replaceString.Length;
        ...
        protected void UpdateLabel()
        {
            ...
            if (m_lineCount != m_TextComponent.textInfo.lineCount)
            {
                string lineNumber = "";
                for (int i = 1; i <= m_TextComponent.textInfo.lineCount; i++)
                {
                    lineNumber += $"{i}\n";
                }
                m_lineNumber.text = lineNumber;
                m_lineCount = m_TextComponent.textInfo.lineCount;
            }
        }
        ...
        void AdjustTextPositionRelativeToViewport(float relativePosition)
        {
            ...
            m_TextComponent.rectTransform.anchoredPosition = new Vector2(m_TextComponent.rectTransform.anchoredPosition.x, (m_TextComponent.preferredHeight - m_TextViewport.rect.height +30) * relativePosition); // padding 30
        ...
        {
            m_lineNumberTransform.anchoredPosition = new Vector2(m_lineNumberTransform.anchoredPosition.x, m_TextComponent.rectTransform.anchoredPosition.y);
